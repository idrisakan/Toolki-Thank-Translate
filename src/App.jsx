...
const App = () => {
  ...
  //apiden gelen diziyii bizden istenilen formata çevir 
...
const handleSwap = () => {
  ...
  // select alanlardaki verileri yer değiş
    ...
    <div className="bg-zinc-900 h-screen text-white grid place-items-center">
      <div className="w-[80vw] max-w-[1100px] flex flex-col justify-center">
        ...
        <div className="flex gap-2 text-black">
          ...
          <button onClick={handleSwap} className="rounded py-2 px-6 bg-zinc-700 text-white transition hover:ring-2 hover:bg-zinc-800 ">Değiş</button>
        ...
        <button
          ...
          className="rounded-md py-3 px-5 text-[17px] font-semibold cursor-pointer bg-zinc-700 mt-3 hover:ring-2 hover:bg-zinc-900 transition ">Çevir</button>
      </div>
    </div>
  )
}
